...
server.get('/test/backend', async (req, res) => {
  ...
  const tests = [
    { name: 'Statistiche', url: 'http://localhost:3000/cliente/statistiche' },
    { name: 'Lista clienti', url: 'http://localhost:3000/cliente/lista' },
    { name: 'Lista base', url: 'http://localhost:3000/cliente/lista?limit=1' }
  ];
